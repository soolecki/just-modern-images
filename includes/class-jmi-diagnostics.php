...
final class JMI_Diagnostics {
	...
	public static function label( $reason ) {
		$labels = array(
			...
			'alpha_lost'                 => __( 'The encoder removed transparency from the generated image.', 'just-modern-images' ),
			'alpha_unverified'           => __( 'The generated image transparency could not be verified safely.', 'just-modern-images' ),
			'alpha_unsupported'          => __( 'This server does not preserve transparency in this format. Another safe format will be used.', 'just-modern-images' ),
			...
			'publish_target_conflict'    => __( 'Another file already uses the generated variant name.', 'just-modern-images' ),
			'storage_not_writable'       => __( 'The uploads directory is not currently writable.', 'just-modern-images' ),
			'storage_write_failed'       => __( 'The server could not write the generated file to uploads storage.', 'just-modern-images' ),
